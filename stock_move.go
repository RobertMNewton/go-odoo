...
type StockMove struct {
	...
	CheckId                               *Relation  `xmlrpc:"check_id,omitempty"`
	...
	MoveLineIdsPicked                     *Relation  `xmlrpc:"move_line_ids_picked,omitempty"`
	...
	PickingTypePrefillShopFloorLots       *Bool      `xmlrpc:"picking_type_prefill_shop_floor_lots,omitempty"`
	...
	WorksheetNote                         *String    `xmlrpc:"worksheet_note,omitempty"`
