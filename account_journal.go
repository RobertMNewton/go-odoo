...
type AccountJournal struct {
	AbaBsb                        *String     `xmlrpc:"aba_bsb,omitempty"`
	AbaFic                        *String     `xmlrpc:"aba_fic,omitempty"`
	AbaSelfBalancing              *Bool       `xmlrpc:"aba_self_balancing,omitempty"`
	AbaUserNumber                 *String     `xmlrpc:"aba_user_number,omitempty"`
	AbaUserSpec                   *String     `xmlrpc:"aba_user_spec,omitempty"`
