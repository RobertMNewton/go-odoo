...
type StockWarehouseOrderpoint struct {
	...
	AllowedReplenishmentUomIds  *Relation  `xmlrpc:"allowed_replenishment_uom_ids,omitempty"`
	...
	ManufacturingVisibilityDays *Float     `xmlrpc:"manufacturing_visibility_days,omitempty"`
	...
	ReplenishmentUomId          *Many2One  `xmlrpc:"replenishment_uom_id,omitempty"`
