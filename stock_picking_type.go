...
type StockPickingType struct {
	...
	CountMoInProgress                  *Int        `xmlrpc:"count_mo_in_progress,omitempty"`
	CountMoLate                        *Int        `xmlrpc:"count_mo_late,omitempty"`
	CountMoToClose                     *Int        `xmlrpc:"count_mo_to_close,omitempty"`
	...
	PrefillShopFloorLots               *Bool       `xmlrpc:"prefill_shop_floor_lots,omitempty"`
